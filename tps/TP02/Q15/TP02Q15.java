...
class SelectionSortParcial {
    ...
    public SelectionSortParcial(Pokemon[] findPokemon, int tam) {
...
public class TP02Q15 {
    ...
    public static void main(String[] args) {
        ...
        SelectionSortParcial selectionSort = new SelectionSortParcial(findPokemon, tam);
        selectionSort.sort();
        ...
        int comp = selectionSort.comp;
        int mov = selectionSort.mov;

        String conteudo = "843610" + "\t" + comp + "\t" + mov + '\t' + executionTime + "ms";

        try (BufferedWriter writer = new BufferedWriter(new FileWriter("843610_partialSelectionSort.txt"))) {
