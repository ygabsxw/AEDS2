...
public class TP02Q09 {
    ...
    private static void heapSort(Pokemon []findPokemon, int tam, int[] comp, int[] mov) {
        ...
        // extrai todos os elementos do heap (um por um)
        for (int i = tam - 1 ; i >= 0 ; i--) {
            // move a raiz para o fim
            mov[0]++;
            swap(findPokemon, 0, i);

            // chama o heapify na heap reduzida
            heapify(findPokemon, i, 0, comp, mov);
        }
    }
    ...
    private static void heapify(Pokemon []findPokemon, int n, int i, int[] comp, int[] mov) {
        ...
        // verifica se o filho da esq existe e eh maior q a raiz
        if (left < n) {
            comp[0]++;
        ...
        // verifica se o filho da dir existe e eh maior q a raiz
        if (right < n) {
            comp[0]++;
    ...
    public static void main(String[] args) {
        ...
        try (BufferedWriter writer = new BufferedWriter(new FileWriter("843610_heapsort.txt"))) {
